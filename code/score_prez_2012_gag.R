...
parti_scores <- c("CEN_gagnabilite", 
                  "SOC_gagnabilite", "ECO_gagnabilite", 
                  "FN_gagnabilite", "FG_gagnabilite", "UMP_gagnabilite")
...
chemin_fichier <- "/Users/augustajomayans/Library/CloudStorage/GoogleDrive-josephine.mayans@gmail.com/Mon Drive/pessd/data/legislatives/2012/candidats_2012_gag.dta"
