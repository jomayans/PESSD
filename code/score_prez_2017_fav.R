...
df_long <- df2017 %>%
  pivot_longer(cols = c("SOC", "LR", "FI", "REM", "FN", "DLF"),
               names_to = "parti",
...
parti_scores <- c("SOC_favorabilite", 
                  "LR_favorabilite", "FI_favorabilite", 
                  "REM_favorabilite", "FN_favorabilite", "DLF_favorabilite")
...
chemin_fichier <- "/Users/augustajomayans/Library/CloudStorage/GoogleDrive-josephine.mayans@gmail.com/Mon Drive/pessd/data/legislatives/2017/candidats_2017_fav.dta"
